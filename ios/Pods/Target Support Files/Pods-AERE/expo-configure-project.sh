...
with_node \
  ...
  --target "/Users/jamesogilvie/Development/Espere/react-native-aere/ios/Pods/Target Support Files/Pods-AERE/ExpoModulesProvider.swift" \
  --entitlement "/Users/jamesogilvie/Development/Espere/react-native-aere/ios/AERE/AERE.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-av" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-router" "expo-splash-screen"
